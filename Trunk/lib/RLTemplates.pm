...
#   %{date:sec:zp}                     The current seconds past the hour (00-59)
#   %{date:min}                        The current minutes past the hour (0-59)
#   %{date:min:zp}                     The current minutes past the hour (00-59)
#   %{date:hour}                       The current hour of the day (0-23)
#   %{date:hour:zp}                    The current hour of the day (00-23)
#   %{date:day}                        The current day of the month (1-31)
#   %{date:day:zp}                     The current day of the month (01-31)
#   %{date:monthnumber}                The current month's number (1-12)
#   %{date:monthnumber:zp}             The current month's number (01-12)
...
------
        ...
        macros are as follows:
                ...
                %{channel:dc:date}      dc:date of RSS channel. (undefined in
                                        some RSS)
                %{date:sec}             The current seconds past the hour (0-59)
                %{date:sec}             The current seconds past the hour (00-59)
                %{date:min}             The current minutes past the hour (0-59)
                %{date:min}             The current minutes past the hour (00-59)
                %{date:hour}            The current hour of the day (0-23)
                %{date:hour}            The current hour of the day (00-23)
                %{date:day}             The current day of the month (1-31)
                %{date:day}             The current day of the month (01-31)
                %{date:monthnumber}     The current month's number (1-12)
                %{date:monthnumber}     The current month's number (01-12)
                %{date:year}            The current year (4 digit )
                %{date:weekday}         The current day of the week (1=Sun, 2=Mon, etc.)
                %{date:yearday}         The current day of the year (1-365)
                %{date:dow}             The current day of the week (3 letters, first capatialized)
